...
Public Class History_Page
    ReadOnly MyFormat As String = "{0,-50}{1,-25}{2,-15}{3,-30}{4,-25}" 'format list box
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles BtnClearHist.Click
        ...
        DialogResult = MsgBox("WIPING HISTORY WILL RESET SCORE, ARE YOU SURE?", MsgBoxStyle.YesNo, "WARNING")
